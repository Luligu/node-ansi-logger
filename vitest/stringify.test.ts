...
import { colorStringify, debugStringify, historyStringify, jsonStringify, mqttStringify, payloadStringify, stringify } from '../src/stringify.js';
...
describe('Stringify functions', () => {
  ...
  test('do not throw with function keys', () => {
    const input = { myFunc: (): string => 'Hello, world!' };
